...
export default function FeaturedConcertsSection() {
  return (
    <div className="min-h-screen flex items-center justify-center py-[10vh]">
      <section className="w-full max-w-7xl mx-auto h-full flex flex-col">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 md:mb-8 lg:mb-12 text-primary-800 px-4 flex-shrink-0">
